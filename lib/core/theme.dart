...
class AppColors {
  // 主色 — Rojo (국기 빨강)
  static const Color rojo = Color(0xFFFF9933);
  static const Color rojoDeep = Color(0xFFC46F14);
  static const Color rojoLight = Color(0xFFFFB566);

  // 副色 — Gualda (국기 노랑/금)
  static const Color gualda = Color(0xFF138808);
  static const Color gualdaBright = Color(0xFF3DAE2B);
  static const Color gualdaDeep = Color(0xFF0C5E05);
