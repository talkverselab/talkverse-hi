      ...
      body: ListView(
        ...
        children: [
          ...
          _SettingsGroup(items: [
            _SettingItem(icon: Icons.volume_up, title: 'TTS 음성', subtitle: 'hi-IN (시스템 보이스)'),
            _SettingItem(icon: Icons.public, title: '변종', subtitle: 'Mānak Hindī (표준 힌디어)'),
            _SettingItem(icon: Icons.palette, title: '테마', subtitle: '낮 · 사프란·그린 #FF9933'),
          ]),
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.copyright, title: '저작권', subtitle: '힌디어유니버스 · 2026'),
          ]),
