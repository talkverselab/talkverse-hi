...
class _MenuGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = <_MenuItem>[
      _MenuItem(label: '회화', sub: 'Bātchīt', badge: 'Ch', color: AppColors.rojo,
        builder: (_) => const ConversationScreen()),
      _MenuItem(label: '문법', sub: 'व्याकरण', badge: 'G', color: AppColors.rojoDeep,
        builder: (_) => const GrammarHubScreen()),
      _MenuItem(label: '문장 카드', sub: 'वाक्य', badge: 'S', color: AppColors.tinta,
        builder: (_) => const SentenceFlashcardScreen()),
      _MenuItem(label: '말하기', sub: 'बोलना', badge: '🎙', color: AppColors.rojo,
        builder: (_) => const SpeakingPracticeScreen()),
      _MenuItem(label: '청크 검색', sub: 'खोज', badge: '🔍', color: AppColors.gualdaDeep,
        builder: (_) => const ChunkSearchScreen()),
      _MenuItem(label: '동사 활용', sub: 'Rūp', badge: 'V', color: AppColors.irregular,
        builder: (_) => const VerbScreen()),
      _MenuItem(label: '단어', sub: 'Śabd', badge: 'W', color: AppColors.oliva,
        builder: (_) => const TopicVocabScreen()),
      _MenuItem(label: '표현', sub: 'Abhivyakti', badge: 'E', color: AppColors.rojoLight,
        builder: (_) => const TopicVocabScreen(
            title: '주제별 표현',
            asset: 'assets/data/vocab/travel_expressions.json')),
      _MenuItem(label: '빈도 단어', sub: 'Āvṛtti', badge: 'F', color: AppColors.gualda,
        builder: (_) => const WordFreqScreen()),
      _MenuItem(label: '성·수', sub: 'Ling', badge: 'm/f', color: AppColors.mar,
        builder: (_) => const _ComingSoon(title: '성·수 일치')),
      _MenuItem(label: '발음', sub: 'Uccāraṇ', badge: 'ṛ', color: AppColors.er,
        builder: (_) => const _ComingSoon(title: '발음')),
      _MenuItem(label: '단어 카드', sub: 'कार्ड', badge: 'R', color: AppColors.gualdaDeep,
