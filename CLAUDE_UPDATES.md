...
## 런처 아이콘
- `assets/icon/icon.png`·`icon_foreground.png` — 언어 상징 글자 `अ` + 국기 팔레트(PIL 생성). 17개 talkverse 앱 모두 다른 모양이어야 한다는 규칙.
...
## 이 앱 고유 설정
- 팔레트: rojo=FF9933(사프란) gualda=138808(그린)
- TTS: hi-IN
- 메뉴 sub는 데바나가리 폰트 이슈 방지를 위해 로마자 표기.
